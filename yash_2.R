...
training <- data[ind==1, c(1:23)]
test <- data[ind==2, 1:23]
trainingtarget <- data[ind==1, 24]
testtarget <- data[ind==2, 24]
...
model %>%  layer_dense(units = 10, activation = 'relu', input_shape = c(23)) %>%    
